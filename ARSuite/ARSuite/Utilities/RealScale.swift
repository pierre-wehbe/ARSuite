...
public struct TSScale {
    ...
    func displayInch() -> CGFloat {
        ...
        switch (width, height) {
        case (320,480): // iPhone ../4/4s
            return 3.5
        case (320,568): // iPhone 5/5s/SE
            return 4
        case (375,667): // iPhone 6/6+/6s/6s+/7/8
            return 4.7
        case (414,736): // iPhone 7+/8+
            return 5.5
        case (375,812): // iPhone X/Xs
            return 5.5
        case (768,1024): // iPads pro/air2/mini4
    ...
    public func toMeters(inch:CGFloat)->CGFloat{
        return inch * 0.254
    }
...
public extension CGFloat{
    func toPoint(unit:TSUnit)->CGFloat{
